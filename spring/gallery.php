	...
	<div id="site_content">	
	  ...
	  <div id="content">
        <div class="content_item">
          <h2>Our vision</h2>
			<p>Is to become the leading nonprofit organization which focuses 
			on advancing the living conditions of people from different communities</p>
			<h2>Our mission</h2>
			<p>To restore hope and transformation through support, relief to the needy (children, older people, young people, families, single women, minority ethnic groups, and low-income groups). </p>
